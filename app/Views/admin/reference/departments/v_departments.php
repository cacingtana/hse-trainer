                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="general-label">
                            <form action="/inv-back/departments/store" method="post">
                                <?php csrf_field() ?>
                                <div class="form-group row">
                                    <label for="horizontalInput2" class="col-sm-2 col-form-label">Departemen</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="dept-name" required />
                                    </div>
                                </div>
                                <div class="row">
