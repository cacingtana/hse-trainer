...
<div class="page-wrapper">
            ...
            <div class="row mx-0">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 class="page-title">Daftar Role User</h4>
                                <ol class="breadcrumb">
                            ...
                            <div class="col-auto align-self-center">
                                <a href="#" class="btn btn-sm btn-outline-primary ml-2" data-toggle="modal" data-target="#add-role"><i class="fas fa-plus"></i></a>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
    ...
    <!--modal-->
    <div class="modal fade bd-example-modal-lg" id="add-role" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="general-label">
                            <form method="post" action="/inv-back/role/store">
                                <?php csrf_field() ?>
                                <div class="form-group row">
                                    <label for="horizontalInput1" class="col-sm-2 col-form-label">Nama Role User</label>
                                    <div class="col-sm-10">
